...
def helpnote():
	...
	exit(" [*] FACEBOOK :  https://www.facebook.com/Normal.User.Alamgir")
...
def notice():
	...
	runtxt("\033[0;92m ADMIN🧞‍♀️ MESSENGER🔰🥰https://www.facebook.com/Normal.User.Alamgir")
	subprocess.check_output(["am", "start", "https://m.me/Normal.User.Alamgir"])
